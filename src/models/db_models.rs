...
pub struct ThreatModel {
    ...
    pub assumptions_json: Option<serde_json::Value>,
    ...
    pub threats_json: Option<serde_json::Value>,
    pub mitigations_json: Option<serde_json::Value>,
    pub validation_plan_json: Option<serde_json::Value>,
    pub assurance_claims_json: Option<serde_json::Value>,
